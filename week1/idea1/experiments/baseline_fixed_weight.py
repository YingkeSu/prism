"""
Baseline experiment: reliability on, but fixed fusion weights.
"""
...
def run_baseline_fixed_weight(
    *,
    ...
    run_name = f"baseline_fixed_weight_seed{seed}"
    print("=" * 70)
    print(f"Running {run_name}")
    print("=" * 70)
    print(f"timesteps={total_timesteps}, eval_episodes={eval_episodes}, weights={tuple(fixed_weights)}")
    ...
    result = {
        "experiment": "baseline_fixed_weight",
        "run_name": run_name,
        "seed": seed,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run fixed-weight baseline experiment")
    parser.add_argument("--timesteps", type=int, default=1000)
    parser.add_argument("--eval-episodes", type=int, default=50)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--w-lidar", type=float, default=1 / 3)
    parser.add_argument("--w-rgb", type=float, default=1 / 3)
    parser.add_argument("--w-imu", type=float, default=1 / 3)
    ...
    run_baseline_fixed_weight(
        total_timesteps=args.timesteps,
        eval_episodes=args.eval_episodes,
        seed=args.seed,
        fixed_weights=(args.w_lidar, args.w_rgb, args.w_imu),
